...
export async function POST(request: Request) {
  try {
    ...
    if (payload.event === 'payment.captured') {
      ...
      // Force convert subscription_id to string.
      const subscriptionId = payment.subscription_id.toString();
      if (!subscriptionId) {
      ...
      // Try both "userId" and (if needed) other variations by converting to string.
